...
struct Guards {
    ...
    bool game{};          // the game's profile asks for real time (GameProfile::fast_loading_allowed)
};

// Why fast loading is off at the moment, for the log.
enum class Reason { None, Disabled, NotLoading, Sound, Buttons, Movie, Online, Menu, Game };
