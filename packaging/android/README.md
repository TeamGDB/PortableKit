...
| File | What it is |
| --- | --- |
| `AndroidManifest.xml` | The app: `io.github.teamgdb.yakumo`, Android 11 (API 30) and Vulkan 1.1 required, landscape, the libraries extracted so the overlay loader can list them, the backup rules |
